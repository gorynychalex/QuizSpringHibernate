...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            <h3><a href="/start?sessionid=${sessionId}">Quiz System</a></h3>
        </div>
        <ol class="nav navbar-nav pull-right">
            <li class="active"><a href="#">User: ${userquizservice.user.nickname} </a> </li>
    ...
    <div class="container" style="background-color: darkcyan; color: white">
        <h3>Statistic </h3>
            <h2>quiz:${userquizservice.quiz.name}</h2>
